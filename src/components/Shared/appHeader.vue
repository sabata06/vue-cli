            ...
            <div v-if="_isAuthenticated" class="ml-auto flex items-center">
                ...
                <div class="relative group">
                    ...
                    <nav
                        ...
                        <router-link class="mb-2 menu-item" to="/settings">
                        ...
                        <router-link class="mb-2 menu-item" to="/favorites"> <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <router-link class="mb-2 menu-item" to="/likes"> 
